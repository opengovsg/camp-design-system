...
const palettes = {
  main: {
    ...
    subtleBgHover: { value: '{colors.interaction.main-subtle.hover}' },
    subtleBgActive: { value: '{colors.interaction.main-subtle.active}' },
  ...
  sub: {
    ...
    subtleBgHover: { value: '{colors.interaction.sub-subtle.hover}' },
    subtleBgActive: { value: '{colors.interaction.sub-subtle.active}' },
  ...
  critical: {
    ...
    subtleBgHover: { value: '{colors.interaction.critical-subtle.hover}' },
    subtleBgActive: { value: '{colors.interaction.critical-subtle.active}' },
  ...
  warning: {
    ...
    subtleBgHover: { value: '{colors.interaction.warning-subtle.hover}' },
    subtleBgActive: { value: '{colors.interaction.warning-subtle.active}' },
  ...
  success: {
    ...
    subtleBgHover: { value: '{colors.interaction.success-subtle.hover}' },
    subtleBgActive: { value: '{colors.interaction.success-subtle.active}' },
  ...
  neutral: {
    ...
    subtleBgHover: { value: '{colors.interaction.neutral-subtle.hover}' },
    subtleBgActive: { value: '{colors.interaction.neutral-subtle.active}' },
  ...
  info: {
    ...
    // `info` has no dedicated subtle hover/active tokens; reuse the default.
    subtleBgHover: { value: '{colors.utility.feedback.info-subtle}' },
    subtleBgActive: { value: '{colors.utility.feedback.info-subtle}' },
  },
}
